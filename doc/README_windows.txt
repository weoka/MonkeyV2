...
Intro
-----
Monkey (MONK) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Monkey utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.


Setup
-----
Unpack the files into a directory and run monkey-qt.exe.

Monkey Core is the original Monkey client and it builds the backbone of the network.
However, it downloads and stores the entire history of Monkey transactions;

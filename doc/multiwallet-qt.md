...
In order to support loading of multiple wallets in monkey-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is monkey.cpp.
...
Changes to monkey.cpp
----------------------
monkey.cpp is the entry point into monkey-qt, and as such, will require some minor modifications to provide hooks for

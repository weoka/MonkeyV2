...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Monkey Core monkey-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  monkey-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monkey transaction") + "\n" +
                               "  monkey-tx [options] -create [commands]   " + _("Create hex-encoded monkey transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded monkey transaction

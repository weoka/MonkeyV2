                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Monkey Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MONK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and monkey: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Monkey Core"), this);
    aboutAction->setStatusTip(tr("Show information about Monkey Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MONK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MONK addresses"));
    ...
    openAction->setStatusTip(tr("Open a monkey: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Monkey Core help message to get a list with possible Monkey command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Monkey Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Monkey Core"); // default title

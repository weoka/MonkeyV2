Contributing to Monkey Core
==================================

The Monkey Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Monkey Core project, and is not to be
confused with overall Monkey Network Protocol consensus changes.

Whether a pull request is merged into Monkey Core rests with the project merge
...
Patches that change Monkey consensus rules are considerably more involved than
...
Where a patch set proposes to change the Monkey consensus, it must have been
...
The project leader is the release manager for each Monkey Core release.
